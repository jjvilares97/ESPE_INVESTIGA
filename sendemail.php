...
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template){
	...
	if(!$mail->send()) {
		...
		echo '<br><br><br><center><h1 style="color:#00713d">Tu mensaje ha sido enviado!</h1><center>';
		echo '<center><img src="img/dorado.png" width="30%">';
		echo '<center><h1 style="color:#1E1E1E">Gracias por confiar en nosotros</h1><center><br>';
